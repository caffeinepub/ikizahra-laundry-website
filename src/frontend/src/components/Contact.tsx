...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-24 gradient-luxury-beige-gold relative overflow-hidden"
    >
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-sky-300/20 to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-cyan-300/20 to-transparent rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-sky-800/80 max-w-2xl mx-auto leading-relaxed">
            We're ready to serve you. Contact us for more information or to
            place an order
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <Card className="luxury-card border-sky-200/50 hover:scale-105 transition-all duration-300">
              <CardHeader className="pb-3">
                ...
                <CardTitle className="text-base text-sky-900 font-semibold">
                  Phone
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="luxury-card border-sky-200/50 hover:scale-105 transition-all duration-300">
              ...
              <CardContent>
                <p className="text-sm text-sky-700 leading-relaxed">
                  Jl. Cempaka Warna No. 26 RT 09 RW 04, Cempaka Putih, Jakarta
                  Pusat
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="luxury-card border-sky-200/50 hover:scale-105 transition-all duration-300">
              ...
              <CardContent>
                ...
                <p className="text-sm text-sky-700">08:00 - 20:00 WIB</p>
              </CardContent>
            </Card>
          </div>
